...
class ConcreteVisitor1 : IVisitor
{
    ...
    public void VisitConcreteComponentB(ConcreteComponentB component)
        => Console.WriteLine(component.SpecialMethodOfConcreteComponentB() + " + ConcreteVisitor1");
}
...
class ConcreteVisitor2 : IVisitor
{
    ...
    public void VisitConcreteComponentB(ConcreteComponentB component)
        => Console.WriteLine(component.SpecialMethodOfConcreteComponentB() + " + ConcreteVisitor2");
}
