...
class Context
{
    ...
    // Context allows changing the State object at runtime.
...
class ConcreteStateA : State
{
    ...
    {
        Console.WriteLine("ConcreteStateA handle request1.");
    ...
    {
        Console.WriteLine("ConcreteStateA handle request2.");
    }
}
...
class ConcreteStateB : State
{
    public override void Handle1()
    {
        Console.WriteLine("ConcreteStateB handle request1");
    }
