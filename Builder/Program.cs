...
// several variations of Builders, implemented differntly.
public class ConcreteBuilder : IBuilder
{
    ...
    // Concrete builder are supposed to provide their own methods for
    // retrieving results. That's because various types of builders may
    // create entirely different products that don't follow the same
    // interface. Therefore, such methods cannot be declares in the base
...
// It make sense to use the Builder pattern only when your products are
